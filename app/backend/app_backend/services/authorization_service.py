...
from app_backend.domain.circuit_definitions import AllowedActions as DefinitionAllowedActions
from app_backend.domain.circuit_definitions import CircuitDefinitionRecord
from app_backend.domain.datasets import DatasetAllowedActions, DatasetDetail
...
from app_backend.domain.tasks import TaskAllowedActions, TaskDetail
...
class AuthorizationService:
    ...
    def is_visible_dataset(self, dataset: DatasetDetail, state: SessionState) -> bool:
        ...
        if state.runtime_mode == "local":
            return (
                dataset.visibility_scope == "local" and dataset.workspace_id == state.workspace_id
            )
