"""App-local legacy Circuit Definition netlist parsing utilities."""
...
from app_backend.domain.legacy_circuit_definition_netlist.compiler import (
    compile_simulation_topology,
)
from app_backend.domain.legacy_circuit_definition_netlist.ir import CircuitElement, CircuitIR
