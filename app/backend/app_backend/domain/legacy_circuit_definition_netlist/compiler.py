"""Legacy netlist lowering helpers for App Circuit Definition previews."""

from __future__ import annotations

from collections.abc import Callable

from app_backend.domain.legacy_circuit_definition_netlist.ir import CircuitIR
...
def compile_simulation_topology(
    ...
    *,
    ...
    """Lower CircuitIR into the legacy tuple representation used by App previews."""
