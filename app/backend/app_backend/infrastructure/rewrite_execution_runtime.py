        ...
        *,
        ...
        updated_task = self._task_service.update_task_lifecycle(
            TaskLifecycleUpdate(
                ...
                progress_summary="Julia Runner claimed the queued task from backend DB.",
        ...
        self._append_runtime_event(
            ...
            message="Julia Runner claimed the queued task from backend DB.",
            metadata={
...
def _ensure_task_status(
    ...
    *,
    ...
    raise service_error(
        ...
        category="conflict",
        message=(
            f"Cannot {action} task {task.task_id} from status {task.status}; allowed: {allowed}."
        ),
    )
