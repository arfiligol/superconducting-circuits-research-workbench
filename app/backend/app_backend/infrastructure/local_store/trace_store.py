...
from app_backend.infrastructure.local_store.database import DATABASE_PATH
...
ALL_TRACE_SELECTION: TraceSelectionItem = slice(None)
...
class TraceStore(Protocol):
    ...
    def read_axis_slice(
        ...
        *,
        axis_name: str,
        selection: TraceSelectionItem = ALL_TRACE_SELECTION,
    ) -> NDArray[np.generic]: ...
