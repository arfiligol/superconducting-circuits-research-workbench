...
from app_backend.domain.storage import MetadataRecordRef
from app_backend.domain.tasks import TaskResultRefs
from app_backend.infrastructure.app_state_repository import (
