...
async function main() {
  const standaloneDir = join(rootDir, "frontend", ".next", "standalone");
  if (!existsSync(standaloneDir)) {
    throw new Error("Missing frontend/.next/standalone. Run the frontend production build first.");
  }
  ...
  await cp(
    join(rootDir, "frontend", ".next", "static"),
