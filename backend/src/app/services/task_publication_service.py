...
class TaskPublicationDatasetRepository(Protocol):
...
class TaskPublicationSessionRepository(Protocol):
    def get_session_state(self) -> SessionState: ...


class TaskPublicationAuditRepository(Protocol):
    def append(self, record: AuditRecord) -> None: ...


class TaskPublicationRepository(Protocol):
...
class TaskPublicationHost(Protocol):
...
class TaskPublicationService:
    def __init__(
        self,
        repository: TaskPublicationRepository,
        dataset_repository: TaskPublicationDatasetRepository,
        session_repository: TaskPublicationSessionRepository,
        authorization_service: AuthorizationService | None = None,
        audit_repository: TaskPublicationAuditRepository | None = None,
    ) -> None:
