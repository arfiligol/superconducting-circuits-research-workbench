...
platform_require_path "$ROOT_DIR/.venv" "uv sync" "start"
platform_require_path "$ROOT_DIR/backend/.venv" "cd backend && uv sync" "start"
platform_require_path "$ROOT_DIR/frontend/node_modules" "npm install --prefix frontend" "start"
