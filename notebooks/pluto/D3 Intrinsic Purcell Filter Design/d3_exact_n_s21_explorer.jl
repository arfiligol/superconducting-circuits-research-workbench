...
#> tags = ["pluto", "d3", "exact-n", "s21"]
#> description = "Interactive Direct C/K and Exact-12 S21 closure for one D3 Stage-2 Equivalent Circuit candidate."
...
with the existing Exact-12 open state-space implementation and compares it
against the independent direct ``C/K`` response.
...
begin
    ...
    direct_s21 = response_closure.direct.s21
end
...
exact_n_sanity = (
    ...
    finite_direct=all(isfinite, direct_s21),
...
- The direct physical-node ``C/K`` trace and Exact-12 are drawn together; their
  maximum complex residual is reported above.
