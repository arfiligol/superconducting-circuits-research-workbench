...
# ╔═╡ 2f8d70b4-80e1-11f1-a3fe-6d77f937bc1f
begin
	using JosephsonCircuits
	using Plots
end

# ╔═╡ 25fbefc3-21f0-4eb8-bbb5-e81202dd513d
begin
    @variables Cs Lj Cj Ll Ldc K
...
# ╔═╡ 49e5ff12-10f6-4406-ac86-0e706135f052
begin
	start_f = 4.0
	end_f = 8.0
	
	ws = 2*pi*(start_f:0.001:end_f)*1e9
...
# ╔═╡ 68f0197f-4f82-4866-b422-c3bee657293d
...
# ╔═╡ 0476c574-0e48-4c3c-8912-95d835421c8c
plot(
    currentvals/(1e-3),
    ws/(2*pi*1e9),
...
# ╔═╡ 9193cbc6-694e-4256-ab34-b8356dd8d487
begin
    target_current_mA = -0.2
    
    k = argmin(abs.(currentvals ./ 1e-3 .- target_current_mA))
    
    plot(
        ws ./ (2π * 1e9),
        10 .* log10.(abs2.(outvals[:, k])),
        xlabel = "frequency (GHz)",
        ylabel = "S11 (dB)",
        title = "S11 at bias = $(round(currentvals[k] / 1e-3, digits=3)) mA",
        label = false,
    )
end

# ╔═╡ 4b2d771d-c973-41c6-a032-55c7cc5cde6e
begin

    Idc_work = -0.075e-3

    Ipvals = (0.0:0.1:10.0) .* 1e-6

    ws_gain = 2π .* (5.8:0.001:6.2) .* 1e9
...
# ╔═╡ 5db7d510-d9aa-41fe-96f3-7aa5927c18f0


# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
JosephsonCircuits = "23a5dba6-321f-4fcf-be1e-689e290df087"
Plots = "91a5bcdd-55d7-5caf-9e0b-520d859cae80"

[compat]
JosephsonCircuits = "~0.5.2"
Plots = "~1.41.6"
"""
...
manifest_format = "2.0"
project_hash = "8d613cacfb650ef4dbdf69f0c3b72ea6d0826385"
...
deps = ["Preferences", "Printf", "Random"]
git-tree-sha1 = "53cfc49a5cf96d888fb28d5fb1d46065ad0feec8"
...
git-tree-sha1 = "bf2f2041ca5b45f976ec92108403d6efda089a71"
...
version = "0.4.15"
    ...
    FastInterpolationsColorVectorSpaceExt = ["ColorTypes", "ColorVectorSpace"]
...
[[deps.JosephsonCircuits]]
deps = ["AxisKeys", "FFTW", "FastInterpolations", "Graphs", "KLU", "LinearAlgebra", "OrderedCollections", "PrecompileTools", "Printf", "SparseArrays", "StaticArrays", "Statistics", "SymbolicUtils", "Symbolics", "Touchstone", "UUIDs"]
git-tree-sha1 = "e7834579316d9e50119b713bf44e9d90cf7db73c"
...
git-tree-sha1 = "80779cd2ed8292ee98f2ca6c47768882a3abcea1"
...
git-tree-sha1 = "acec255ab714edc8f358bcd5443b52c7111969cc"
...
[[deps.Touchstone]]
git-tree-sha1 = "240fb387bf250b57bb11dc26d6e216aa8778f98e"
uuid = "af4736ee-1570-4274-b14c-898d17d80b75"
version = "0.1.2"
