...
The expected resonance estimate is:

$$f_0 = \frac{1}{2\pi\sqrt{LC}}$$

| L (nH) | C (pF) | Estimated $f_0$ (GHz) |
| --- | --- | --- |
| 10 | 1.0 | 1.59 |
| 5 | 1.0 | 2.25 |
| 10 | 0.5 | 2.25 |

Use this table only as a sanity check. The notebook result must still come from the Julia Core solver path and the extracted response traces.
