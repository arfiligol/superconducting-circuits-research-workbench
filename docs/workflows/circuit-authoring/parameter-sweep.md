...
研究中的直接掃描可以在 Pluto notebook 中繪圖，並把 sweep inputs、units、axes 與 figure generation 放在同一份可重現 notebook 內。

## 下一步

👉 [Notebook Interface](../../reference/notebooks/index.md) — 了解 Pluto 與 Python notebook 的研究角色
