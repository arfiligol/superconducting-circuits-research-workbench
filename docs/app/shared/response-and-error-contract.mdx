...
`Session & Workspace`、`Tasks & Execution`、`Circuit Definitions`、`Analysis Results` 都應回到這份 shared envelope。
...
本頁沿用 [Code Quality / Error Handling](../../reference/guardrails/code-quality/error-handling.mdx) 的高階分類。
