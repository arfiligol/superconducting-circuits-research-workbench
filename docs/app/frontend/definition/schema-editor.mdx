...
schema list browse、simulation execution 與 analysis execution 不屬於本頁責任。

</Aside>

<Aside type="tip" title="Shared Shell">

本頁位於 shared [Header](../shared-shell/header.mdx) / [Sidebar](../shared-shell/sidebar.md) shell 中。
...
| Hints are reference-only | quick reference 幫助撰寫，但 canonical truth 仍以 [Circuit Netlist](../../../reference/data-formats/circuit-netlist.mdx) 為準 |
