...
本頁位於 shared [Header](../shared-shell/header.mdx) / [Sidebar](../shared-shell/sidebar.md) shell 中，但本頁本身不擁有 dataset 或 task context authority。
...
<Tabs>
<TabItem label="數據依賴 (Data Dependencies)">
...
<Tabs>
<TabItem label="建立與開啟 (Create/Open)">
...
<TabItem label="搜尋與排序 (Search/Sort)">
...
*   [Record Format: Circuit Netlist](../../../reference/data-formats/circuit-netlist.mdx)
