...
<Aside type="note" title="分文件決策（目前）">
...
<Aside type="tip" title="目前已落地的最低可行實作">
...
<Aside type="caution" title="目前仍未實作的 profile 能力">
...
<Aside type="tip" title="Split Criteria（何時拆成多份領域文件）">
...
- [Data Formats / Circuit Netlist](../../../reference/data-formats/circuit-netlist.mdx)
