...
<Aside type="note" title="Tech Stack 說明位置">

本頁不展開技術堆疊細節。請以 [Guardrails / Project Basics / Tech Stack](../../../reference/guardrails/project-basics/tech-stack.mdx) 為主。
...
<Aside type="tip" title="已實作到程式的第一階段（2026-02-28）">
...
<Aside type="caution" title="縮放狀態保留條件">
...
<Aside type="tip" title="按鈕與直接操作同步規則">
