...
主要消費者是 Analysis Workbench、[Dashboard](../frontend/workspace/dashboard.mdx)、ResultView API 與 Raw Data Browser。
...
metadata / TraceStore 分工、summary-first query 與 ND payload access 邊界，應同時遵守 [Data Handling](../../reference/guardrails/code-quality/data-handling.mdx)。
...
| [Dashboard](../frontend/workspace/dashboard.mdx) | `Tagged Core Metrics` 摘要可讀回最新標記 |
...
- [Dataset / Design / Trace Schema](../../reference/data-formats/dataset-record.mdx)
