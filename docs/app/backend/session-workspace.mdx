...
| --- | --- |
| [Header](../frontend/shared-shell/header.mdx) | 顯示 active workspace、active dataset 與 user menu |
| [Sidebar](../frontend/shared-shell/sidebar.md) | 需要知道 shell-level context propagation |
| [Dashboard](../frontend/workspace/dashboard.mdx) | dataset metadata editing 依賴 capability flags |
