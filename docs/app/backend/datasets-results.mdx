...
主要消費者是 [Dashboard](../frontend/workspace/dashboard.mdx)、[Raw Data Browser](../frontend/workspace/raw-data-browser.mdx)、Analysis Workbench、ResultView API 與 [Header](../frontend/shared-shell/header.mdx)。
...
identify / tagging mutation 仍由 [Analysis Results](characterization-results.mdx) 定義。
...
- [Analysis Result](../../reference/data-formats/analysis-result.mdx)
