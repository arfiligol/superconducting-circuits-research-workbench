...
audit write semantics、separate audit store 與 retention baseline 由 [Shared / Audit Logging](../shared/audit-logging.mdx) 定義。
...
audit list query 必須沿用 shared [Response & Error Contract](../shared/response-and-error-contract.mdx) 的 cursor-based collection meta。
