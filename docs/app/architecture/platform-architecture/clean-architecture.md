...
- 資料 authority 與 provenance：
  ...
  [Dataset Record Schema](../../../reference/data-formats/dataset-record.mdx)、
  [Analysis Result Schema](../../../reference/data-formats/analysis-result.mdx)
- repository / Unit of Work 讀寫邊界：
  [Query Indexing Strategy](../../../reference/data-formats/query-indexing-strategy.mdx)
