...
- 前置：[為什麼非線性會讓能階間距不一致？](why-nonlinearity-makes-unequal-level-spacing.mdx)
- 下一步：[為什麼 SQUID 可以控制非線性電感值？](squid-controls-nonlinear-inductance.mdx)
- 任務導向：[SQUID Fitting](../../workflows/analysis-fitting/squid-fitting.mdx)
