...
<Aside type="note" title="為什麼 Cooper pair 是玻色子？">
...
<Aside type="caution" title="這不是單電子波函數">
...
- 下一步：[為什麼磁通量會是量子化的？](why-flux-is-quantized.mdx) — 利用宏觀波函數的單值性推導磁通量子化
