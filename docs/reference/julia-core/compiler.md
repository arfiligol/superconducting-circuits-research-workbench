...
- `SeriesInductor`, `ShuntInductor`, and `SeriesResistor` lowering to target rows;
...
- section-aligned MTL coupled-window relations generated by `couple_transmission_window!`, lowered as C12 capacitor rows and K mutual-inductance rows;
