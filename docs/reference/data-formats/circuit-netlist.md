...
| --- | --- |
| [Circuit Definitions](../app/backend/circuit-definitions.md) | persisted source / validation / preview authority |
| [Schema Editor](../app/frontend/definition/schema-editor.md) | source editing、auto-format、hint table、persisted preview |
...
| Concern | Reference |
| --- | --- |
| Parser / validator | [`circuit.py`](../../../core/simulation/domain/circuit.py) |
