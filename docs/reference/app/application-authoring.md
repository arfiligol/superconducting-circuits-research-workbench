...
1. `README.md`
2. [Folder Structure](../guardrails/project-basics/folder-structure.md)
3. [Tech Stack](../guardrails/project-basics/tech-stack.md)
4. [Simulation Interface Boundaries](../architecture/simulation-interface-boundaries.md)
5. [Product Async Contracts](../architecture/product-async-contracts.md)
...
12. Surface-specific frontend docs:
    ...
    - [Dataset](frontend/workspace/dataset.md)
