...
4. [Python Core](python-core.mdx) for Python-owned canonical contracts and analysis package boundaries.
...
|---|---|---|
| [Python Core](python-core.mdx) | Python contracts, shared models, and analysis package boundary | `core/`, `core/python/`, `core/analysis/` |
