...
owner: docs-team
audience: team
scope: Core reference 索引，條列 Julia Core、Julia Visualizer、Julia Runner、Julia Analysis Bridge、Python analysis 與 Python contracts。
version: v0.10.0
...
4. [Python Core](python-core.md) for Python-owned canonical contracts and analysis package boundaries.
...
| Julia Analysis Bridge owns Pluto/Python analysis calls | wrap Python analysis through PythonCall without moving algorithms into Julia |
...
|---|---|---|
| [Python Core](python-core.md) | Python contracts, shared models, and analysis package boundary | `core/`, `core/python/`, `core/analysis/` |
