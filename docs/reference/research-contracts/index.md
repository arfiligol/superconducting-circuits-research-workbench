...
| [Circuit Runtime / Python Consumer](circuit-runtime-python-consumer.md) | CONVERGING staged `execute`/`resolve` actions, immutable receipts, typed objective builder, and read-only result/campaign/report resolution |
