...
| --- | --- | --- |
| [Theming](theming.mdx) | 你在改 color tokens、dark mode、theme switch | visual tokens and theme rules |
| [Component Guidelines](component-guidelines.mdx) | 你在選元件、設計 dialog/form/table | component semantics |
| [Layout Patterns](layout-patterns.mdx) | 你在改 shell、master-detail、responsive layout | screen structure |
| [State Management](state-management.mdx) | 你在改 SWR、form state、mutations | client/server state behavior |
| [Accessibility](accessibility.mdx) | 你在處理 keyboard flow、aria、contrast | accessibility baseline |
| [Routing](routing.mdx) | 你在改 route structure、nested layouts、context-carrying route behavior | navigation and route boundaries |
