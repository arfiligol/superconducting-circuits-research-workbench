...
Branch and worktree selection comes only from the active host delivery profile;
do not infer either from prompt scaffolding. `Allowed Area`, `Do Not Touch`,
and internal worker assignments remain optional scoping tools.
...
- Branch and worktree selection comes only from the active host delivery profile; do not infer either from prompt scaffolding.
- `Allowed Area`, `Do Not Touch`, and internal worker assignments are optional scoping tools.
