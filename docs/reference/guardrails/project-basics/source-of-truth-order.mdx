...
owner: docs-team
audience: team
scope: "定義 Product App docs、reference docs、Julia Core authoring、Julia Runner、Backend、adapter 與 retired surfaces 的裁決順序"
version: v3.2.0
...
- **Current app/core/notebooks boundaries beat old root layout**：
  `app/backend/`、`app/frontend/`、`app/desktop/`、`core/julia/`、`core/python/analysis/`、`core/python/circuit_libraries/`、`notebooks/` 才是 architecture-level surfaces。
...
- [Canonical Contract Registry](../../architecture/canonical-contract-registry.mdx)
