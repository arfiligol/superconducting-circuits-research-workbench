...
| Python Notebook | Python-native analysis, external-result, quantum-modeling, and inspection surface | No | Yes | Yes |
...
Python Notebook is a Python-native data-analysis, external-result, quantum-modeling, dynamics/pulse, and inspection surface. It may normalize upstream FEM/simulation results, inspect Touchstone/trace/Zarr payloads, run equivalent-circuit fitting experiments, explore scqubits quantum-modeling workflows, and run QuTiP/qutip-qip dynamics or pulse studies when those dependencies are isolated to the Python notebook or a future Python quantum package.
