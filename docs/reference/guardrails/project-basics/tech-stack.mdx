...
| `core/python/schemdraw_circuit_library/` | Python Schemdraw renderer-side reusable circuit visual components |
...
| Python Schemdraw circuit renderer | uv workspace package under `core/python/schemdraw_circuit_library/` |
...
- **Topology**:
    ...
    - `core/python/schemdraw_circuit_library/` owns Python Schemdraw visual components that consume renderer-neutral schematic data; it must not define solver semantics or become an App/Backend runtime dependency
