...
| Product App docs, Architecture Contracts, Data Contracts, app shared/frontend/backend/desktop contracts, Python Notebook app-prototyping path, archived App workflows | `docs/app/` |
...
14. `scripts/` shall not be a user-facing command-line product surface
15. root `backend/`, `frontend/`, `desktop/`, `cli/`, `src/` residues shall not be reinterpreted as formal architecture boundary
