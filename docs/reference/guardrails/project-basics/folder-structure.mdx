...
`core/analysis/superconducting_circuits_analysis/`,
`core/python/sc_data_contracts/sc_data_contracts/`, and
`core/python/schemdraw_circuit_library/schemdraw_circuit_library/`.
...
| Python Schemdraw renderer-side circuit visual components | `core/python/schemdraw_circuit_library/` |
...
- **Python Schemdraw circuit visual components** go to `core/python/schemdraw_circuit_library/`; they consume renderer-neutral schematic data and must not become solver or Core semantics.
