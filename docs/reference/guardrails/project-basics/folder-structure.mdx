...
- **Concepts** are repository-local implementation mental models and handoffs
  for Physics Foundations, Circuit Authoring Model, Equivalent Circuit
  Modeling, Quantum Modeling, Quantum Dynamics & Pulse Simulation, and
  GDSFactory-Compatible Artifacts. Reusable cross-repo theory belongs in the
  SCQ_Design Super Repo `docs/knowledge/` tree.
