...
This section defines the current branch fundamentals: product scope, technical direction, and repository structure.
...
- Legacy command workflow, retired Python UI runtime, separate queue worker runtime, and Python in-process Julia runtime are migration legacy and must not be the default landing zone for new features.
```
