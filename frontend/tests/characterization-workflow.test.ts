...
describe("characterization source contracts", () => {
  it("keeps characterization run-first without duplicating task-management walls", () => {
    expect(characterizationWorkspaceSource).toContain('title="Design Scope"');
    expect(characterizationWorkspaceSource).toContain('title="Selected Analysis"');
    expect(characterizationWorkspaceSource).toContain('title="Latest Result"');
    expect(characterizationWorkspaceSource).toContain('<div className="space-y-6">');
    expect(characterizationWorkspaceSource).toContain("SecondaryDisclosure");
    expect(characterizationWorkspaceSource).toContain("Trace Scope");
    expect(characterizationWorkspaceSource).toContain("Browse Traces");
    expect(characterizationWorkspaceSource).toContain("Sweep Axis");
    expect(characterizationWorkspaceSource).toContain("Collection Summary");
    expect(characterizationWorkspaceSource).toContain("Current Step");
    ...
    expect(characterizationWorkspaceSource).toContain("Saved Results");
    expect(characterizationWorkspaceSource).toContain("Fit Diagnostics");
    expect(characterizationWorkspaceSource).toContain("Artifact Payload");
    expect(characterizationWorkspaceSource).toContain("Run History");
    expect(characterizationWorkspaceSource).toContain("Collection Details");
    expect(characterizationWorkspaceSource).toContain("Downstream Context");
    ...
    expect(characterizationWorkspaceSource).not.toContain('title="Design / Source Scope"');
    expect(characterizationWorkspaceSource).not.toContain('title="Data Collection Review"');
    expect(characterizationWorkspaceSource).not.toContain('title="Analysis Pipeline"');
    expect(characterizationWorkspaceSource).not.toContain('title="Active Analysis Run"');
    expect(characterizationWorkspaceSource).not.toContain('title="Result Preview"');
    expect(characterizationWorkspaceSource).not.toContain('title="Downstream Analysis / Next Step"');
    expect(characterizationWorkspaceSource).not.toContain("Collection Hint");
    expect(characterizationWorkspaceSource).not.toContain("Derived Collection Hint");
    expect(characterizationWorkspaceSource).not.toContain("Debug Payload");
